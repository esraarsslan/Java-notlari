...
public class Stringbuilder_01 {
    ...
    public static void main(String[] args) {
        ...
        StringBuilder strb3 = new StringBuilder();// 16 tane kutu olusturur StringBuilder ...
        strb3.append("Cat");
        ...
        String abc = "Java";
        abc = abc.replace("a", "i");// abc ye atama yapinva "JIvi" yazar yoksa orjinal degerini bozmaz.
        ...
        /**
         *  NEDEN SB'U STRING'E CEVIRMEK ISTERIZ?
         *  SB'LER DEISIME ACIK OLDUGU ICIN DATANIZIN DEGISIME KAPATILMASINI ISTERSINIZ VE STRINGE CEVIRMEK ISTERSINIZ.
         *  STRINGDE OLUP SA SB'DA OLMAYAN METHDLAR VAR O YZDEN STRINDEKILERI KULLANIP TAKRAR SB'A DONEBILIRSINIZ...
         */
