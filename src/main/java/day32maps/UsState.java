    ...
    public String getCapital() {
        ...
        public static String getStateNameFromAbbreviation( String abbreviation){
          ...
          return   Arrays.stream(values()).
                    filter(UsState ->UsState.getAbbreviation().
                            equals(abbreviation)).findFirst().get().getStateName();

        }
    public static String getStateNameFromCapital (String capital){

       return Arrays.stream(values()).
                filter(t->t.getStateName().
                        equals(capital)).
            ...
            // ExP===Baskenti verilen  state'in kisaltmasni ekrana yazdiriniz.

    public static String getStateKisaltma (String capital){
